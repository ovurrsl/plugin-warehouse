...
function shapeKey(rack: RackLike): string {
  ...
  return [
    Math.round(rotation / ANGLE_EPSILON),
    rack.bayClearWidth,
    rack.uprightWidth,
    rack.depth,
    rack.depthPositions,

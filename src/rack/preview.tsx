...
import { getRackPreviewMaterial } from './materials'
 ...
 * pallet uses: deciding at render time and then calling `useRegistry` inside the
 * resulting branch is a rules-of-hooks violation, and it throws the moment a
 * node crosses between preview and committed on one component instance.
 *
 ...
 */
export default function PalletRackPreview({ node }: { node: PalletRackNode }) {

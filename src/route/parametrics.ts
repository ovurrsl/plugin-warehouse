...
export const routeParametrics: ParametricDescriptor<RouteNode> = {
  groups: [
    ...
    },
    {
      label: 'Style & Colors',
      fields: [
        { key: 'fillEnabled', kind: 'boolean' },
        { key: 'fillColor', kind: 'color', visibleIf: (node) => node.fillEnabled !== false },
        { key: 'edgeColor', kind: 'color' },
        { key: 'edgeStyle', kind: 'enum', options: ['solid', 'dashed'], display: 'segmented' },
      ],
    },
    {
      label: 'Flow & Arrows',
